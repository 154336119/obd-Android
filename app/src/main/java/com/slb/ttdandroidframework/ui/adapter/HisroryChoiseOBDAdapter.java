...
public class HisroryChoiseOBDAdapter extends BaseQuickAdapter<ChoiseObdEntity,BaseViewHolder> {
    private int selPosition=0;

    public HisroryChoiseOBDAdapter(List<ChoiseObdEntity> data) {
        //有点问题 先注释
        super(R.layout.adapter_history_choise, data);
    }
    @Override
    protected void convert(final BaseViewHolder baseViewHolder, final ChoiseObdEntity entity) {
