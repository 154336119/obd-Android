package com.slb.ttdandroidframework.weight.hellocharts.renderer;
...
import com.slb.ttdandroidframework.weight.hellocharts.view.Chart;
...
//        mPaint.setColor(Color.parseColor("#00A4EF"));
//        mPaint.setStrokeWidth(ChartUtils.dp2px(density, line.getStrokeWidth()));
//        mPaint.setPathEffect(line.getPathEffect());
//        mPaint.setShader(null);
        linePaint.setColor(Color.parseColor("#00A4EF"));
        canvas.drawPath(path, linePaint);
        if (line.isFilled()) {
            linePaint.setColor(Color.parseColor("#354460"));
            drawArea(canvas, line);
        }
        path.reset();
    }
    ...
    private void drawPoint(Canvas canvas, Line line, PointValue pointValue, float rawX, float rawY,
        ...
        if (ValueShape.SQUARE.equals(line.getShape())) {
            ...
            pointStrokePaint.setColor(Color.parseColor("#2B3648"));
            pointStrokePaint.setStyle(Paint.Style.FILL);
            canvas.drawCircle(rawX, rawY, pointRadius - 6, pointStrokePaint);//加入空心坐标描边
    ...
    private void drawArea(Canvas canvas, Line line) {
        ...
        path.lineTo(right, contentRect.bottom);
        path.lineTo(left, contentRect.bottom);
        path.close();
