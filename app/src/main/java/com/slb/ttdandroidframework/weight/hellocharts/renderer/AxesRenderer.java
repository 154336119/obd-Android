...
import com.slb.ttdandroidframework.weight.hellocharts.util.AxisAutoValues;
import com.slb.ttdandroidframework.weight.hellocharts.util.ChartUtils;
import com.slb.ttdandroidframework.weight.hellocharts.util.FloatUtils;
...
public class AxesRenderer {
    ...
    private void initAxisPaints(Axis axis, int position) {
        ...
        namePaintTab[position].setColor(Color.WHITE);
