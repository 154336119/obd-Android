package com.slb.ttdandroidframework.weight;
...
public class CountDownTimerUtils extends CountDownTimer {
    ...
    private String strTimeOutText="重新发送";
    /**
...
//        mTextView.setText(spannableString);
    ...
    public void setTimeOutText(String strTimeOutText) {
        this.strTimeOutText = strTimeOutText;
    }

    @Override
    public void onFinish() {//计时结束之后实现这个方法
        mTextView.setText(strTimeOutText);
